...
const wallOtherRow = document.getElementById("wall-other-row");
const wallDepthDec = document.getElementById("wall-depth-dec");
const wallDepthInc = document.getElementById("wall-depth-inc");
const wallDepthReadout = document.getElementById("wall-depth-readout");
